...
from flet import ThemeMode, View, AppBar, Colors, Button, FloatingActionButton, Icons, TextField, ListView, Text, \
    Column, Card, Row, Icon, ListTile, PopupMenuButton, PopupMenuItem, Dropdown, FontWeight, Container
...
def main(page: flet.Page):
    ...
    def ver_detalhes(pessoa):
        ...
        text_profisso.value = pessoa.profissao
                    ...
                    controls=[
                        ...
                        Container(
                            Column([
                                text_nome,
                                Row([
                                    Icon(Icons.MAN, color.PRIMARY), size=20),
                                ])
                            ])
                        )
                    ]
    ...
    text_profissao = Text(weight=FontWeight.BOLD, size=24)
    text_sexo = Text(we
