...
from flet import ThemeMode, View, AppBar, Colors, Button, FloatingActionButton, Icons, TextField, ListView, Text, \
    Column, Card, Row, Icon, ListTile, PopupMenuButton, PopupMenuItem
...
def main(page: flet.Page):
                ...
                ListTile(
                    ...
                    trailing=PopupMenuButton(
                        ...
                        items=[
                            ...
                            PopupMenuItem("Masculino", icon=Icons.MALE, on_click=lambda: excluir(item)),
                            PopupMenuItem("Feminino", icon=Icons.FEMALE, on_click=lambda: excluir(item))
                        ]
                    ),
                )
            )
    ...
    input_sobrenome = TextField(label="Sobrenome", hint_text="Digite seu sobrenome", on_submit=salvar_dados)
